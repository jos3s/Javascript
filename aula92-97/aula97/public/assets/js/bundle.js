...
var maiusculas = document.querySelector('.chk-maiuscula');
var minusculas = document.querySelector('.chk-minuscula');
var num = document.querySelector('.chk-num');
var simb = document.querySelector('.chk-simb');
...
function gera() {
  return Object(_gerador__WEBPACK_IMPORTED_MODULE_0__["default"])(qtd.value, maiusculas.checked, minusculas.checked, num.checked, simb.checked) || 'Nada selecionado, selecione pelo menos uma opção';
}
...
function rand() {
  var min = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 97;
  var max = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 123;
...
function geraSenha(qtd, maiuscula, minuscula, num, simb) {
  var senhaArray = [];
  qtd = Number(qtd);
